...
public class NocabRNG : JsonConvertible
{
  public static NocabRNG newRNG
  {
    ...
    get { return new NocabRNG(DateTime.UtcNow); }
  }
  ...
  public static NocabRNG defaultRNG
  {
    ...
    get
    {
      if (defaultRNG_ == null)
      {
        defaultRNG_ = new NocabRNG(5489);
      } // Default seed certified random according to Wikipedia
      return defaultRNG_;
    }
  }
  ...
  public string NocabName
  {
    get { return this.nocabNameable.getNocabName(); }
  }
  ...
  public NocabRNG(int seed)
  {
    ...
    string name = this.generateUUID() + System.DateTime.UtcNow.Ticks.ToString();
    this.nocabNameable = new NocabNameable(this, name);
  }

  public NocabRNG(string seed)
    : this(seed.GetHashCode()) { }

  public NocabRNG(System.Object seed)
    : this(seed.GetHashCode()) { }

  public NocabRNG(JsonObject jo)
  {
    this.loadJson(jo);
  }
  ...
  {
    return this.myRNG.extract_number();
  }
  ...
  public int generateInt(int low, int high, bool lowInclusive = true, bool highInclusive = true)
  {
    ...
    {
      string errMsg =
        $"Invalid range provided low={low}, high={high}. Swapping now. "
    ...
    if (delta < (lowDelta + highDelta))
    {
      throw new System.Exception(
        $"Invalid random int range. Low={low}  high={high}  "
  ...
  private int generateIntInternal(int low, int high)
  {
    ...
    return low
      + (int)
        Math.Floor((myRNG.extract_number() / NocabMT.MAX_POSSIBLE_VALUE_PLUS_ONE) * (high - low));
  }
  ...
  )
  {
    ...
    float denominator = highInclusive
      ? NocabMT.UNSIGNED_MAX_POSSIBLE_VALUE
      : // (2^32) - 1
  ...
  )
  {
    ...
    double denominator = highInclusive
      ? NocabMT.UNSIGNED_MAX_POSSIBLE_VALUE
      : // (2^32) - 1
      NocabMT.MAX_POSSIBLE_VALUE_PLUS_ONE; //  2^32
    return low + ((randomNumber / denominator) * (high - low));
  ...
  {
    return (myRNG.extract_number() % 2) == 1;
  }
  ...
  public int d100
  {
    get { return this.generateIntInternal(1, 101); }
  }
  public int d20
  {
    get { return this.generateIntInternal(1, 21); }
  }
  public int d12
  {
    get { return this.generateIntInternal(1, 13); }
  }
  public int d6
  {
    get { return this.generateIntInternal(1, 7); }
  }
  public int d4
  {
    get { return this.generateIntInternal(1, 5); }
  }

  public int rollNSidedDie(int n)
  {
    return this.generateIntInternal(1, Math.Max(1, n + 1));
  }
  #endregion
  ...
  {
    get { return this.generateFloat(0f, 1f, true, true); }
  }
  public double unitDouble
  {
    get { return this.generateDouble(0d, 1d, true, true); }
  }
  #endregion
  ...
  public T randomElem_Set<T>(HashSet<T> elems)
  {
    ...
    throw new Exception(
      $"Something has gone wrong!" + $"RandIndex = {randIndex}, elems.Count = {elems.Count}"
    );
  }
  ...
  public int randomIndex(int count)
  {
    ...
    {
      throw new System.Exception(
        $"Must provide a positive count to randomIndex(). " + $"Count {count}"
      );
    }
  ...
  public int randomIndex(IList list)
  {
