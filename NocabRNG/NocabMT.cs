...
public class NocabMT : JsonConvertible
{
  ...
  public NocabMT() : this(5489) { }
  public NocabMT(int seed) : this((uint)seed) { }
  public NocabMT(object seed) : this(seed.GetHashCode()) { }
  public NocabMT(JsonObject jo) { this.loadJson(jo); } // LOADING ONLY.
  ...
  public JsonObject toJson()
  {
    ...
    for (int i = 0; i < stateLength; i++) { ja.Add(mtState[i]); }
    result["mt"] = ja;
    return result;
  }
